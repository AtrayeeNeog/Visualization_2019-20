...
dt01 <- dt %>% filter(dt$eType == 6) 
G101 <- qt1 %>% filter(qt1$eType == 6)
G201 <- qt2 %>% filter(qt2$eType == 6)
G301 <- qt3 %>% filter(qt3$eType == 6)
G401 <- qt4 %>% filter(qt4$eType == 6)
G501 <- qt5 %>% filter(qt5$eType == 6)
