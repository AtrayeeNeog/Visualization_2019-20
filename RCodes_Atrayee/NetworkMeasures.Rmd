...
#Node or Vetex Options: Size and Color
V(dt_graph2)$color <- "grey"
V(dt_graph2)[closeness(dt_graph)>8]$color <- "yellow"  #Destinguishing High Degree Nodes as yellow
V(dt_graph2)$size=(closeness(dt_graph)+300)/20 #because we have wide range, I am dividing by 5 to keep the high in-degree nodes from overshadowing everything else.
...
#Node or Vetex Options: Size and Color
V(qt1_graph2)$color <- "grey"
V(qt1_graph2)[closeness(qt1_graph)>8]$color <- "yellow"  #Destinguishing High Degree Nodes as yellow
V(qt1_graph2)$size=(closeness(qt1_graph)+300)/20
...
#Node or Vetex Options: Size and Color
V(qt2_graph2)$color <- "grey"
V(qt2_graph2)[closeness(qt2_graph)>8]$color <- "yellow"  #Destinguishing High Degree Nodes as yellow
V(qt2_graph2)$size=(closeness(qt2_graph)+300)/20
...
#Node or Vetex Options: Size and Color
V(qt3_graph2)$color <- "grey"
V(qt3_graph2)[closeness(qt3_graph)>8]$color <- "yellow"  #Destinguishing High Degree Nodes as yellow
V(qt3_graph2)$size=(closeness(qt3_graph)+300)/20
...
#Node or Vetex Options: Size and Color
V(qt4_graph2)$color <- "grey"
V(qt4_graph2)[closeness(qt4_graph)>8]$color <- "yellow"  #Destinguishing High Degree Nodes as yellow
V(qt4_graph2)$size=(closeness(qt4_graph)+300)/20
...
#Node or Vetex Options: Size and Color
V(qt5_graph2)$color <- "grey"
V(qt5_graph2)[closeness(qt5_graph)>8]$color <- "yellow"  #Destinguishing High Degree Nodes as yellow
V(qt5_graph2)$size=(closeness(qt5_graph)+300)/20
...
#Node or Vetex Options: Size and Color
V(s1_graph2)$color <- "grey"
V(s1_graph2)[closeness(s1_graph)>8]$color <- "yellow"  #Destinguishing High Degree Nodes as yellow
V(s1_graph2)$size=(closeness(s1_graph)+300)/20
...
#Node or Vetex Options: Size and Color
V(s3_graph2)$color <- "grey"
V(s3_graph2)[closeness(s3_graph)>8]$color <- "yellow"  #Destinguishing High Degree Nodes as yellow
V(s3_graph2)$size=(closeness(s3_graph)+300)/20
...
#Node or Vetex Options: Size and Color
V(proc_s1_full_graph2)$color <- "grey"
V(proc_s1_full_graph2)[closeness(proc_s1_full_graph)>8]$color <- "yellow"  #Destinguishing High Degree Nodes as yellow
V(proc_s1_full_graph2)$size=(closeness(proc_s1_full_graph)+300)/20
...
#Node or Vetex Options: Size and Color
V(proc_s3_full_graph2)$color <- "grey"
V(proc_s3_full_graph2)[closeness(proc_s3_full_graph)>8]$color <- "yellow"  #Destinguishing High Degree Nodes as yellow
V(proc_s3_full_graph2)$size=(closeness(proc_s3_full_graph)+300)/20
