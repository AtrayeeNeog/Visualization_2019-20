...
```{r}
contacter_count <- count(qt2_01, "Source") #492777,490041,550361,512397,533140,568093
contacted_count <- count(qt2_01, "Target") #493044,492777,490041,550361
...
```{r}
communication1 <- qt2_01 %>% filter(Source==490041 & Target==589639)
communication2 <- qt2_01 %>% filter(Source==492777 & Target==623295)
communication3 <- qt2_01 %>% filter(Source==492777 & Target==635665)
communication4 <- qt2_01 %>% filter(Source==599956 & Target==490041)
communication5 <- qt2_01 %>% filter(Source==599956 & Target==589639)
communication6 <- qt2_01 %>% filter(Source==599956 & Target==635665)
communication7 <- qt2_01 %>% filter(Source==623295 & Target==635665)
communication8 <- qt2_01 %>% filter(Source==635665 & Target==492777)
