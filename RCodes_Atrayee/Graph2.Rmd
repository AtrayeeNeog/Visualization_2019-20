...
## Excatly same number as Template
...
unique(qt2_6$SourceLocation) # 4 3 2 1 0 5
unique(qt2_6$TargetLocation) # 3 1 4 2 0 5
unique(qt2_6$SourceLatitude) # 1 -25 -22 -29  33  22
unique(qt2_6$SourceLongitude) # -165 -111   91  -13  -41  156
unique(qt2_6$TargetLatitude) # -25 -29   1 -22  33  22
unique(qt2_6$TargetLongitude) # -111  -13 -165   91  -41  156
unique(qt2_6$Source)
unique(qt2_6$Target)
unique(qt2_6$Weight) #4 2 5 3 1


range(qt2_6$Source) # 464459 649553
range(qt2_6$Target) # 499467 657173
range(qt2_6$Time) # 14845147 30224347
income_cat_qt1 <- NULL


hist(qt2_6$Weight)
unique(qt2_6$Weight) #4 2 5 3 1
range(qt2_6$Weight) #1 5
```
...
```{r}
count(qt2_6, "Source") #538892,542965,572391 have travelled only once
```
