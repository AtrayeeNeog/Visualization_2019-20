...
## Seed 1:
```{r}
s1_red <- data.table::fread(here::here("dataQ2","dfSeed1Reduced.csv"))
s1_l1 <- data.table::fread(here::here("dataQ2","InitialGraphs", "dfSeed1_Lvl1.csv"))
s1_l2 <- data.table::fread(here::here("dataQ2","InitialGraphs", "dfSeed1_Lvl2.csv"))
s1 <- data.table::fread(here::here("dataQ2","InitialGraphs", "dfSeed1_Extended.csv"))
```
...
## Proc seed 3:
nodes_g3 <- mutate(nodes, id = arr[2:84])
edges_g3 <- mutate(edges, from = from - 1, to = to - 1)
q2s1 <- forceNetwork(Links = edges_g3, Nodes = nodes_g3, Source = "from", Target = "to", 
             NodeID = "label", Group = "id", Value = "weight", linkDistance = 300,
             opacity = 1, fontSize = 16, zoom = TRUE, legend = TRUE)

saveNetwork(q2s1, file = "q2s1.html")
```
...
## Proc seed 3:
nodes_g3 <- mutate(nodes, id = arr[2:3])
edges_g3 <- mutate(edges, from = from - 1, to = to - 1)
q2s1l1 <- forceNetwork(Links = edges_g3, Nodes = nodes_g3, Source = "from", Target = "to", 
             NodeID = "label", Group = "id", Value = "weight", linkDistance = 300,
             opacity = 1, fontSize = 16, zoom = TRUE, legend = TRUE)

saveNetwork(q2s1l1, file = "q2s1L1.html")
```
...
## Proc seed 3:
nodes_g3 <- mutate(nodes, id = arr[2:3587])
edges_g3 <- mutate(edges, from = from - 1, to = to - 1)
q2s1l2 <- forceNetwork(Links = edges_g3, Nodes = nodes_g3, Source = "from", Target = "to", 
             NodeID = "label", Group = "id", Value = "weight", linkDistance = 300,
             opacity = 1, fontSize = 16, zoom = TRUE, legend = TRUE)

saveNetwork(q2s1l2, file = "q2s1L2.html")
```
...
## Proc seed 3:
nodes_g3 <- mutate(nodes, id = arr[2:891])
edges_g3 <- mutate(edges, from = from - 1, to = to - 1)
q2s1full <- forceNetwork(Links = edges_g3, Nodes = nodes_g3, Source = "from", Target = "to", 
             NodeID = "label", Group = "id", Value = "weight", linkDistance = 300,
             opacity = 1, fontSize = 16, zoom = TRUE, legend = TRUE)

saveNetwork(q2s1full, file = "q2s1full.html")
...
nodes_g3 <- mutate(nodes, id = arr[2:3])
edges_g3 <- mutate(edges, from = from - 1, to = to - 1)
q2s2l1 <- forceNetwork(Links = edges_g3, Nodes = nodes_g3, Source = "from", Target = "to", 
             NodeID = "label", Group = "id", Value = "weight", linkDistance = 300,
             opacity = 1, fontSize = 16, zoom = TRUE, legend = TRUE)

saveNetwork(q2s2l1, file = "q2s2L1.html")
```
...
nodes_g3 <- mutate(nodes, id = arr[2:3587])
edges_g3 <- mutate(edges, from = from - 1, to = to - 1)
q2s2l2 <- forceNetwork(Links = edges_g3, Nodes = nodes_g3, Source = "from", Target = "to", 
             NodeID = "label", Group = "id", Value = "weight", linkDistance = 300,
             opacity = 1, fontSize = 16, zoom = TRUE, legend = TRUE)

saveNetwork(q2s2l2, file = "q2s2L2.html")
```
...
nodes_g3 <- mutate(nodes, id = arr[2:2111])
edges_g3 <- mutate(edges, from = from - 1, to = to - 1)
q2s2full <- forceNetwork(Links = edges_g3, Nodes = nodes_g3, Source = "from", Target = "to", 
             NodeID = "label", Group = "id", Value = "weight", linkDistance = 300,
             opacity = 1, fontSize = 16, zoom = TRUE, legend = TRUE)

saveNetwork(q2s2full, file = "q2s2full.html")
```

## Seed 3:
```{r}
s3_red <- data.table::fread(here::here("dataQ2","dfSeed3Reduced.csv"))
s3_l1 <- data.table::fread(here::here("dataQ2","InitialGraphs", "dfSeed3_Lvl1.csv"))
s3_l2 <- data.table::fread(here::here("dataQ2","InitialGraphs", "dfSeed3_Lvl2.csv"))
s3 <- data.table::fread(here::here("dataQ2","InitialGraphs", "dfSeed3_Extended.csv"))
```
...
## Proc seed 3:
nodes_g3 <- mutate(nodes, id = arr[2:97])
edges_g3 <- mutate(edges, from = from - 1, to = to - 1)
q2s3 <- forceNetwork(Links = edges_g3, Nodes = nodes_g3, Source = "from", Target = "to", 
             NodeID = "label", Group = "id", Value = "weight", linkDistance = 300,
             opacity = 1, fontSize = 16, zoom = TRUE, legend = TRUE)

saveNetwork(q2s3, file = "q2s3.html")
```
...
nodes_g3 <- mutate(nodes, id = arr[2:3])
edges_g3 <- mutate(edges, from = from - 1, to = to - 1)
q2s3l1 <- forceNetwork(Links = edges_g3, Nodes = nodes_g3, Source = "from", Target = "to", 
             NodeID = "label", Group = "id", Value = "weight", linkDistance = 300,
             opacity = 1, fontSize = 16, zoom = TRUE, legend = TRUE)

saveNetwork(q2s3l1, file = "q2s3L1.html")
```
...
## Proc seed 3:
nodes_g3 <- mutate(nodes, id = arr[2:3238])
edges_g3 <- mutate(edges, from = from - 1, to = to - 1)
q2s3l2 <- forceNetwork(Links = edges_g3, Nodes = nodes_g3, Source = "from", Target = "to", 
             NodeID = "label", Group = "id", Value = "weight", linkDistance = 300,
             opacity = 1, fontSize = 16, zoom = TRUE, legend = TRUE)

saveNetwork(q2s3l2, file = "q2s3L2.html")
```
...
## Proc seed 3:
nodes_g3 <- mutate(nodes, id = arr[2:982])
edges_g3 <- mutate(edges, from = from - 1, to = to - 1)
q2s3full <- forceNetwork(Links = edges_g3, Nodes = nodes_g3, Source = "from", Target = "to", 
             NodeID = "label", Group = "id", Value = "weight", linkDistance = 300,
             opacity = 1, fontSize = 16, zoom = TRUE, legend = TRUE)

saveNetwork(q2s3full, file = "q2s3full.html")
```
