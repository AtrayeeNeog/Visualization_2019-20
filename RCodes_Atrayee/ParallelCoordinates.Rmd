...
ggarrange(com_temp, com_g1, com_g2, com_g3, com_g4, com_g5, ncol = 2, nrow = 3)
...
ggarrange(dem_temp, dem_g1, dem_g2, dem_g3, dem_g4, dem_g5, ncol = 2, nrow=3)
```
...
ggarrange(tra_temp, tra_g1, tra_g2, tra_g3, tra_g4, tra_g5, ncol = 2, nrow = 3)
```
...
ggarrange(pro_temp, pro_g1, pro_g2, pro_g3, pro_g4, pro_g5, ncol=2, nrow = 3)
```
