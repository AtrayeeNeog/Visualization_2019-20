...
#s1 <- data.table::fread(here::here("dataQ3","InitialGraphs", "dfProcSeed3-Graph2Full.csv"))
```
...
## Seed 2:
```{r}
#s2_red <- data.table::fread(here::here("dataQ2","dfSeed2Reduced.csv"))
s2_l1 <- data.table::fread(here::here("dataQ2","InitialGraphs", "dfSeed1_Lvl1.csv"))
s2_l2 <- data.table::fread(here::here("dataQ2","InitialGraphs", "dfSeed1_Lvl2.csv"))
#s2 <- data.table::fread(here::here("dataQ3","InitialGraphs", "dfProcSeed3-Graph2Full.csv"))
```
...
#s3 <- data.table::fread(here::here("dataQ3","InitialGraphs", "dfProcSeed3-Graph2Full.csv"))
```
