...
dt01 <- dt %>% filter(dt$eType == 5) 
G101 <- qt1 %>% filter(qt1$eType == 5)
G201 <- qt2 %>% filter(qt2$eType == 5)
G301 <- qt3 %>% filter(qt3$eType == 5)
G401 <- qt4 %>% filter(qt4$eType == 5)
G501 <- qt5 %>% filter(qt5$eType == 5)
