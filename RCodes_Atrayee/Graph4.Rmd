...
time <- qt4_6 %>% filter(Time==16486747 | Time==18214747 | Time==21152347 |Time==24608347 | Time==30137947 | Time==30224347 ) #12 
...
```{r}
unique(qt4_23$Source) 
unique(qt4_23$Target)
```
...
```{r}
count(qt4_6, "Source") #538892,542965,572391 have travelled only once; Not in the common list
```
