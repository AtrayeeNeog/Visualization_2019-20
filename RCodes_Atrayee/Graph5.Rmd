...
weight <- qt5_6 %>% filter(Weight==-1 | Weight==4 | Weight==1 | Weight==5 ) #27 vals; 
SLoc <- qt5_6 %>% filter(SourceLocation==0 | SourceLocation==3 | SourceLocation==2 ) #32; in order: 3,2,0
TLoc <- qt5_6 %>% filter(TargetLocation==3 | TargetLocation==0 | TargetLocation==5 | TargetLocation==4) #30; 
time <- qt5_6 %>% filter(Time==1296000 | Time==1641600 | Time==6912000 |Time==8640000 | Time==8985600 | Time==9504000 | Time==10454400 | Time==11232000 | Time==12614400 | Time==14169600 ) #12 
...
```{r}
unique(qt5_23$Source) #636721
unique(qt5_23$Target) #585417 461577 629826 618398 655265 588802 499177 482579 638734 557626 492039 605235 590595
```
