...
```{r}
# TargetLocation:0
df1 %>% filter(TargetLocation==0)
```


### 2 nodes based on:
### 1. 3 Groups based on Source Location
### 2. 73,74,75 from Source Location 2 travelled within days of each other
### 3. 39,40,41 from Source Location 3 travelled within days of each other
### 4. 85,85,87 from Source Location 1 travelled within days of each other
