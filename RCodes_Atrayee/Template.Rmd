...
```{r}
contacter_count <- count(dt01, "Source") #492777,490041,550361,512397,533140,568093
contacted_count <- count(dt01, "Target") #493044,492777,490041,550361
...
```{r}
count(dt01, vars = c("Source", "Target"))
```

```{r}
communication1 <- dt01 %>% filter(Source==490041 & Target==589639)
communication2 <- dt01 %>% filter(Source==492777 & Target==623295)
communication3 <- dt01 %>% filter(Source==492777 & Target==635665)
communication4 <- dt01 %>% filter(Source==599956 & Target==490041)
communication5 <- dt01 %>% filter(Source==599956 & Target==589639)
communication6 <- dt01 %>% filter(Source==599956 & Target==635665)
communication7 <- dt01 %>% filter(Source==623295 & Target==635665)
communication8 <- dt01 %>% filter(Source==635665 & Target==492777)
